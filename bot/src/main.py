...
async def process_description(message: Message, state: FSMContext) -> None:
    ...
    await message.answer(
        f"{status}\n\nШаг 4/4: Отправь цену в рублях (только число, например: 299.99)",
        reply_markup=cancel_keyboard,
    )
